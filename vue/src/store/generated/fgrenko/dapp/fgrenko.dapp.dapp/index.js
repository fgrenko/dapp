...
import { Params } from "./module/types/dapp/params";
import { Task } from "./module/types/dapp/task";
export { Params, Task };
...
export default {
    ...
    actions: {
        init({ dispatch, rootGetters }) {
            console.log('Vuex module: fgrenko.dapp.dapp initialized!');
        ...
        async QueryTasks({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryTasks', payload: { options: { all }, params: { ...key }, query } });
